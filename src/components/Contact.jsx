  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'shamaltheekshana36@gmail.com',
      link: 'mailto:shamaltheekshana36@gmail.com'
    },
    {
      icon: (
      ...
      label: 'LinkedIn',
      value: 'linkedin.com/in/shamal-theekshana',
      link: 'https://www.linkedin.com/in/shamal-theekshana-0930b3324'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: 'GitHub',
      value: 'github.com/shamaltheekshana',
      link: 'https://github.com/shamal35'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            >
              <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <span className="text-accent font-semibold">freelance projects</span>. Let's create something amazing together!
              </p>
            </motion.div>
          </motion.div>
