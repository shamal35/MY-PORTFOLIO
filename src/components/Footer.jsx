...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/shamaltheekshana',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/shamal-theekshana-59694b1a9',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:shamaltheekshana@example.com',
      icon: (
  ...
  return (
    <footer className="relative bg-gradient-to-t from-slate-950 via-slate-900 to-slate-900 border-t border-slate-800/50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-white">
                Shamal<span className="text-primary">.dev</span>
              </h3>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-sm">
              Cybersecurity enthusiast passionate about Malware Research & SOC operations. 
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 rounded-lg bg-slate-800/50 border border-slate-700/50 flex items-center justify-center text-gray-400 hover:text-white hover:bg-primary/20 hover:border-primary/50 transition-all duration-300"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Open for Internship Opportunities</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <p className="text-gray-500 text-sm">
            © {currentYear} <span className="text-gray-400">Shamal Theekshana</span>. All rights reserved.
          </p>
      ...
      <div className="absolute bottom-0 left-1/4 w-1/2 h-32 bg-primary/5 blur-3xl rounded-full"></div>
    </footer>
  );
};
